...
async def mememify(interaction: discord.Interaction, image_url: Optional[str], top_text: Optional[str], bottom_text: Optional[str], font: str, overlay: Optional[str], overlayposx: Optional[float], overlayposy: Optional[float], overlayscale: Optional[float], width: Optional[int], height: Optional[int]):
